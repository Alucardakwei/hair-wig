...
/* ===================== PRODUCT DATA ===================== */
// Photo IDs are real, free-to-use Unsplash photos (wig / hair related searches).
const PRODUCTS = [
  { id: "p1", name: "Aurora Lace Front", type: "100% Human Hair - Lace Front", price: 289, oldPrice: 340, photoId: "1663582816182-15cf69d87665" },
  { id: "p2", name: "Noir Bob", type: "Synthetic - Chin Length Bob", price: 129, oldPrice: null, photoId: "1573617868130-7e757dbad187" },
  { id: "p3", name: "Golden Hour Waves", type: "100% Human Hair - Body Wave", price: 319, oldPrice: null, photoId: "1700219212623-77aebb917034" },
  { id: "p4", name: "Silk Press Bob", type: "Human Hair Blend - Straight Bob", price: 179, oldPrice: 210, photoId: "1583724711595-ed09eedf1ff8" },
  { id: "p5", name: "Honey Balayage Unit", type: "100% Human Hair - Full Lace", price: 349, oldPrice: null, photoId: "1559564071-dfa53d83b513" },
  { id: "p6", name: "Midnight Curl Crown", type: "Synthetic - Deep Curl", price: 149, oldPrice: null, photoId: "1663582815412-665909d70e01" },
  { id: "p7", name: "Ivory Blonde Bob", type: "100% Human Hair - Lace Front Bob", price: 259, oldPrice: null, photoId: "1634315775834-3e1ac73de6b6" },
  { id: "p8", name: "Chestnut Glow", type: "Human Hair Blend - Layered Long", price: 229, oldPrice: 265, photoId: "1624489173879-7cc62610ddea" },
];
  ...
  grid.innerHTML = PRODUCTS.map(p => `
    <div class="card">
      <div class="card-media">
        <img src="${imgUrl(p.photoId, 500, 640)}" alt="${p.name}" loading="lazy">
...
function renderDrawer(){
  ...
  body.innerHTML = cart.map(i => {
    ...
    return `
      <div class="cart-item">
        <img src="${imgUrl(p.photoId, 120, 150)}" alt="${p.name}">
